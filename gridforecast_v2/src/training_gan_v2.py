...
@hydra.main(config_path="../config", config_name='train_gan_v2')
def train(cfg):
    ...
    gen_optimizer = factory.create_optimizer(optimizer_param, gen_model)
    dis_optimizer = factory.create_optimizer(optimizer_param, dis_model)
    lr_scheduler = factory.create_lr_scheduler(lr_scheduler_param, gen_optimizer)
